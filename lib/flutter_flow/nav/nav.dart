...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const List03UserSelectWidget() : const Auth1Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => const List03UserSelectWidget(),
        ),
        FFRoute(
          name: 'CreateEmployee',
          path: '/createEmployee',
          builder: (context, params) => const CreateEmployeeWidget(),
        ),
        FFRoute(
          name: 'Auth1',
          path: '/login',
